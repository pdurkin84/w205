...
if __name__ == '__main__':
    ...
    l = StdOutListener(60)
    auth=tweepy.OAuthHandler("JgsCBhbvj5S94q5od6icfMOiw", "8ShclUq6t9X8jfSeAM8lVpYD7NyPMjkiuzRC6FVDeCShOMCHfd")
    auth.set_access_token("934581358344790016-FV4ScMij9uvA9Lqn16Nm8clVQXQesuz", "SWrFmv9LatPTz0fp7hamuIs3hvnG1v82ewV68lsuxDyPa")
